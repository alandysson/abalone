This is a simple project for practice the knowledge in NextJS. Is a menu for show jewelry. In it you'll see some features, how: choice items for category, add items to cart, list of cart items and more.
